...
class Auth extends CI_Controller
{
    ...
    private function _login()
    {
        ...
        if ($user) {
            ...
            if ($user['is_active'] == 1) {
                ...
                $this->session->set_flashdata('message', '<div class="alert alert-danger" role="alert">Your email not activated</div>');
                redirect('auth');
            }
        } else {
    ...
    public function registration()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->session->set_flashdata('message', '<div class="alert alert-success" role="alert">Congratulations! Your account has been created! Please activated your account</div>');
            redirect('auth');
        }
    }
    ...
    private function _sendEmail($token, $type)
    {
        ...
        $this->email->from('csmatuda@gmail.com', 'Matuda.ID');
    ...
    public function forgotpassword()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            if ($user) {
                ...
                $this->session->set_flashdata('message', '<div class="alert alert-danger" role="alert">Email not registered or active</div>');
    ...
    public function changepassword($token)
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            // menghapus token jika berhasil mengganti password
            $this->db->delete('user_token', ['email' => $email]);

            // menghapus session untuk mereset password
